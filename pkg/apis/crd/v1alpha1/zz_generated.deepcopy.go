...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FirstNCaptureConfig) DeepCopyInto(out *FirstNCaptureConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FirstNCaptureConfig.
func (in *FirstNCaptureConfig) DeepCopy() *FirstNCaptureConfig {
	if in == nil {
		return nil
	}
	out := new(FirstNCaptureConfig)
	in.DeepCopyInto(out)
	return out
}
